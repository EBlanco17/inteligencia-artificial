...
class Dijsktra:
    ...
    def dibujar(self, camino):
        ...
        color = ['#E36B2C' if nodo in camino else '#23B4C4' for nodo in nodos]
        
        nx.draw(G, pos, node_color=color, node_size=1700, node_shape='H', with_labels=True, font_size=8)
